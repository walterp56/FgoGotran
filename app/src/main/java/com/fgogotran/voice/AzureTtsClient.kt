...
class AzureTtsClient @Inject constructor() {
    ...
    private companion object {
        ...
        const val SHORT_BREAK_MS = 40
        const val SENTENCE_BREAK_MS = 135
        const val EMOTIONAL_BREAK_MS = 155
        const val ELLIPSIS_BREAK_MS = 290
        const val LINE_BREAK_MS = 150
        const val PHRASE_BREAK_MS = 65
