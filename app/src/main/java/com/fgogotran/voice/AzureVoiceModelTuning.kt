...
internal object AzureVoiceModelTuning {
    ...
    private val TUNING_BY_VOICE = mapOf(
        ...
        "zh-CN-XiaokeNeural" to childDialogue("zh-CN-XiaokeNeural"),
        "zh-CN-XiaoyuNeural" to femaleDialogue("zh-CN-XiaoyuNeural"),
        "zh-CN-Xiaoxiao2Neural" to femaleDialogue("zh-CN-Xiaoxiao2Neural"),
        "zh-CN-YunhanNeural" to youngMaleDialogue("zh-CN-YunhanNeural"),
        "zh-CN-YunxiaoNeural" to youngMaleDialogue("zh-CN-YunxiaoNeural"),
        "zh-CN-YunyiNeural" to youngMaleDialogue("zh-CN-YunyiNeural"),
