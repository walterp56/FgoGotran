const fs = require('fs');
const filePath = 'app/src/main/java/com/fgogotran/ui/screen/VoiceSettingsScreen.kt';
...
console.log(`voice resources added: ${entries.length}`);
