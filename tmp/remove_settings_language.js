...

{
  ...
  text = replaceOnce(
    ...
    '',
    'SettingsScreen remove language selector definitions'
  );

  write(path, text);
}

console.log('settings language UI removed');
